...
(
	...
	always @ (posedge clk or posedge rst) begin
	  if(rst) begin
	  	...
	  	reg1_i  <= 16'b0000000000110010;
	  	reg2_i  <= 16'b0000000001100010;
	  	reg3_i  <= 16'b0000000010001110;
	  	reg4_i  <= 16'b0000000010110101;
	  	reg5_i  <= 16'b0000000011010101;
	  	reg6_i  <= 16'b0000000011101101;
	  	reg7_i  <= 16'b0000000011111011;
	  	reg8_i  <= 16'b0000000100000000;
	  	reg9_i  <= 16'b0000000011111011;
	  	reg10_i <= 16'b0000000011101101;
	  	reg11_i <= 16'b0000000011010101;
	  	reg12_i <= 16'b0000000010110101;
	  	reg13_i <= 16'b0000000010001110;
	  	reg14_i <= 16'b0000000001100010;
	  	reg15_i <= 16'b0000000000110010;
	  end
    end // always
